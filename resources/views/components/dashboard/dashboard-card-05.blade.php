<div class="flex flex-col col-span-full sm:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100 flex items-center">
        ...
        <div class="relative ms-2" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
            ...
            <div class="z-10 absolute bottom-full start-1/2 -translate-x-1/2">
                <div
    ...
    <div class="px-5 py-3">
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 me-2 tabular-nums">$<span id="dashboard-card-05-value">57.81</span></div>
