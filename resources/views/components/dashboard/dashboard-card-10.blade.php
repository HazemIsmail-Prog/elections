            ...
            <table class="table-auto w-full">
                ...
                <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                        ...
                        <th class="p-2 whitespace-nowrap">
                            <div class="font-semibold text-start">Email</div>
                        </th>
                        <th class="p-2 whitespace-nowrap">
                            <div class="font-semibold text-start">Spent</div>
                        </th>
                        <th class="p-2 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start">alexshatov@gmail.com</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start font-medium text-green-500">$2,890.66</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start">philip.h@gmail.com</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start font-medium text-green-500">$2,767.04</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-lg text-center">🇩🇪</div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start">mirkofisuk@gmail.com</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start font-medium text-green-500">$1,220.66</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-lg text-center">🇫🇷</div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start">longburak@gmail.com</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-start font-medium text-green-500">$1,890.66</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-lg text-center">🇬🇧</div>
                        </td>
