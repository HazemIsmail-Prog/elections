    ...
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                ...
                <div
                    class="origin-top-end z-10 absolute top-full end-0 min-w-36 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"                
        ...
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 me-2">${{ number_format($dataFeed->sumDataSet(2, 1), 0) }}</div>
