...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        class="origin-top-end z-10 absolute top-full min-w-44 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 {{$align === 'end' ? 'end-0' : 'start-0'}}"                
        ...
        <ul>
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                    <svg class="w-3 h-3 fill-current text-indigo-300 shrink-0 me-2" viewBox="0 0 12 12">
