...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <div class="absolute top-0 end-0 w-2.5 h-2.5 bg-rose-500 border-2 border-white rounded-full"></div>
    </button>
    <div
        class="origin-top-end z-10 absolute top-full -me-48 sm:me-0 min-w-80 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 {{$align === 'end' ? 'end-0' : 'start-0'}}"                
